...
public class OrderController {
    ...
    @Operation(summary = "Place a new order", description = "Create a new order for a user with a list of order items.")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Order placed successfully"),
            @ApiResponse(responseCode = "400", description = "Invalid input")
    })
    @PostMapping
    public OrderInfoDTO placeOrder(@RequestParam Long userId, @RequestBody List<com.example.dto.OrderItemDTO> items) {
